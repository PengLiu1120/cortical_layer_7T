...
for ind = 1:length(subject)
    ...
    for h = 1:length(hemi)
        ...
        for r = 1:length(res)
             ...
             try
                load(sprintf('%s_aQSM_mface_21layer_mean_thrs_%s_%s_70.mat',subject{ind},hemi{h},res{r}));
                load(sprintf('%s_aQSM_mhand_21layer_mean_thrs_%s_%s_70.mat',subject{ind},hemi{h},res{r}));
                load(sprintf('%s_aQSM_mfoot_21layer_mean_thrs_%s_%s_70.mat',subject{ind},hemi{h},res{r}));
                actionmaps = 1;
             catch
             ...
             if actionmaps == 1
                 ...
                 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                 table_allsubjects_fingers_long = [table_allsubjects_fingers_long; mean_T1_D1_21_abs;mean_T1_D2_21_abs;mean_T1_D3_21_abs];
                 ...
                 table_allsubjects_fingers_short(ind,:) = [transpose(mean_T1_D1_21_abs(:,1)) transpose(mean_T1_D2_21_abs(:,1)) transpose(mean_T1_D3_21_abs(:,1)) subject_code(ind) ind transpose(mean_T1_D1_21_abs(1,6)) transpose(mean_T1_D2_21_abs(1,6)) transpose(mean_T1_D3_21_abs(1,6)) h r];
                 T(ind,:) = [transpose(mean_T1_D1_21_abs(:,1)) transpose(mean_T1_D2_21_abs(:,1)) transpose(mean_T1_D3_21_abs(:,1)) subject_code(ind) ind transpose(mean_T1_D1_21_abs(1,6)) transpose(mean_T1_D2_21_abs(1,6)) transpose(mean_T1_D3_21_abs(1,6)) h r];
                     
                 % specify datasets that contain NaN values in QSM of layers #4 - #19:
                 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                 tmp = [mean_T1_D1_21_abs(:,1) mean_T1_D2_21_abs(:,1) mean_T1_D3_21_abs(:,1)];
    ...
    saveas(figure(ind),sprintf('%s_aQSM_mFaceHandFoot_rotated_%s_70.eps',subject{ind},res{r}),'epsc');
    saveas(figure(ind),sprintf('%s_aQSM_mFaceHandFoot_rotated_%s_70.fig',subject{ind},res{r}));
    saveas(figure(ind),sprintf('%s_aQSM_mFaceHandFoot_rotated_%s_70.jpeg',subject{ind},res{r}));
