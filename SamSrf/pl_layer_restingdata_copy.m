%% Resting state data copy
% This script copies resting state data from preprocessing folder to
% Nighres surface mapping pipeline with BID format
%% ........................................................................
% Written by P.Liu
% Optimized by P.Liu
...
for i_sub=1:size(Subjects, 2)
    ...
    SourceDir = fullfile(RootPath, CurrSubj, FldFun, FldRS);
    TargetDir_1 = fullfile(DataPath, CurrSubj, FldDev, [FldSub CurrSub], FldRS);
    mkdir (TargetDir_1);
    TargetDir_2 = fullfile(DataPath, CurrSubj, FldDev, [FldSub CurrSub]);
    
    FunImg = 'adata.nii';
    RSImg = 'resting_state.nii';
    
    meanImg = 'resting_mean.nii.gz';
    
    copyfile(fullfile(SourceDir,FunImg),fullfile(TargetDir_1, RSImg));
    copyfile(fullfile(SourceDir,meanImg),TargetDir_2);
