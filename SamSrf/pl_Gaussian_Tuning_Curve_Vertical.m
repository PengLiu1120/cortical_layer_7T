function pl_Gaussian_Tuning_Curve_Vertical(Hemis, ModelFiles, ROIFiles)
...
for i_fit = 1:size(Coarse_Fit_Only, 2)
    ...
    for i_hemi = 1:size(Hemis, 2)
        ...
        CurrSrfFile = [CurrHemi '_' ModelFiles];
        
        CurrROIFile = [CurrHemi '_' ROIFiles];
        
        MapFile = samsrf_fit_prf(Model, CurrSrfFile, CurrROIFile);
