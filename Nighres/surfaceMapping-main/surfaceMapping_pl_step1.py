...
04. Inhomogeneity correction and skull stripping
...
#map_data = BIDS_path + 'sub-frj/anat/sub-frj_part-mag_SWI.nii.gz'
#map_data = BIDS_path + 'derivatives/sub-frj/func/sub-frj_task-rest_bold_mean.nii.gz'
#map_data = BIDS_path + 'derivatives/sub-frj/func/sub-frj_task-pRF_bold_mean.nii.gz'
...
transform_data = ''
#transform_data = BIDS_path + 'derivatives/sub-frj/QSM/sub-frj_Chimap.nii.gz'
#transform_data = BIDS_path + 'derivatives/sub-frj/resting_state/sub-frj_task-rest_bold_ecm_rlc.nii.gz'
#transform_data = BIDS_path + 'derivatives/sub-frj/pRF_statisticalMaps/'
