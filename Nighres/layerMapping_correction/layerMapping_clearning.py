...
14. Process additional data (if data is specified)
...
BIDS_path = '/Volumes/IKND/AG_Kuehn/Peng/LayerPRF/SurfaceCleaning/unk742/'
...
if os.path.isfile(os.path.join(out_dir, 'sub-' + sub + '_run-01_T1map' + resampled + '_biasCorrected.nii.gz')) and reprocess != True:
	...
	os.system('matlab -nosplash -nodisplay -r \"preproc_sensemap(\'' + T1w_masked + '\'); exit;\"')
	os.system('matlab -nosplash -nodisplay -r \"preproc_sensemap(\'' + T1map_masked + '\'); exit;\"')
