%% Plot calibrated rescaled layer-specific percent signal change results
% .........................................................................
% This script plots the rescaled and calibrated layer-specific percent
% signal change results for young and old group respectively, and for each
% individual.
% .........................................................................
% Written by P.Liu
% Optimized by P.Liu
...
%% ........................................................................Set directory
% .........................................................................Specify RootDir
RootDir = '/home/pliu/Documents/LayerPRF/LayerMapping';
...
%% ........................................................................Plot calibrated and rescaled percent signal change results for young and old group
% .........................................................................Specify plot parameters
percent_signal_change_young='D3_calibrated_res_all_percent_signal_change_young.mat';
load(percent_signal_change_young);
percent_signal_change_old='D3_calibrated_res_all_percent_signal_change_old.mat';
...
%% ........................................................................Plot calibrated and rescaled percent signal change results for each individual
percent_signal_change_difference_young='calibrated_res_all_percent_signal_change_difference_young.mat';
load(percent_signal_change_difference_young);
percent_signal_change_difference_old='calibrated_res_all_percent_signal_change_difference_old.mat';
...
for i_young=1:size(Young, 2)
    ...
    for i_cond = 1:size(Conditions,2)
        ...
        DataPath = fullfile(RootDir, DataDir);
        cd(DataPath);
        
        percent_signal_change_all = [CurrCond '_calibrated_res_all_percent_signal_change_young'];
    ...
    FigName = [CurrSubj '_calibrated_rescale_percent_signal_change_and_difference.png'];
...
for i_old=1:size(Old, 2)
    ...
    for i_cond = 1:size(Conditions,2)
        ...
        percent_signal_change_all = [CurrCond '_calibrated_res_all_percent_signal_change_old'];
        load(percent_signal_change_all);
