...
D2D3Signal_young = load([Conditions{1} '_res_all_percent_signal_change_young']);
D2D3Signal_old = load([Conditions{1} '_res_all_percent_signal_change_old']);

D2Signal_young = load([Conditions{2} '_res_all_percent_signal_change_young']);
D2Signal_old = load([Conditions{2} '_res_all_percent_signal_change_old']);

D3Signal_young = load([Conditions{3} '_res_all_percent_signal_change_young']);
D3Signal_old = load([Conditions{3} '_res_all_percent_signal_change_old']);
