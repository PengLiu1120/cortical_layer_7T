...
%% ........................................................................Set directory
Result_Dir = 'C:\Users\Peng Liu admin\Documents\Nature_Neuroscience\Layer_Specific\08_LayerExtraction\Resting_State_mean';
cd(Result_Dir);

FigurePath = 'C:\Users\Peng Liu admin\Documents\Nature_Neuroscience\Layer_Specific\08_LayerExtraction\Resting_State_mean';
...
resting_state_young = 'resting_state_young.mat';
load(resting_state_young);
resting_state_old = 'resting_state_old.mat';
...
%% ........................................................................Calculate mean
mean_young = nanmean(resting_state_young,2);
mean_old = nanmean(resting_state_old,2);
...
for ind = 1:n_young    
    figure(1)        
    plot(resting_state_young(:,ind),'Color',color_ind,'LineWidth',4)
    hold on;
end
...
for ind = 1:n_old    
    figure(2)        
    plot(resting_state_old(:,ind),'Color',color_ind,'LineWidth',4)
    hold on;
end
...
for i_young=1:size(Young, 2)
    ...
    plot(resting_state_young(:,i_young),'k','LineWidth',4)
    
    cd(FigurePath);
    
    FigName = [CurrSubj '_resting_state.png'];
...
for i_old=1:size(Old, 2)
    ...
    plot(resting_state_young(:,i_old),'k','LineWidth',4)
