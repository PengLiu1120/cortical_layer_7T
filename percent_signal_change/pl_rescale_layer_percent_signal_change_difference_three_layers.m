%% Layer-specific Percent Signal Response Difference for Three Layers
% .........................................................................
...
%% ........................................................................Specify parameters
% .........................................................................Specify root path
DataPath = '/home/pliu/Documents/LayerPRF/Layer_Specific/08_LayerExtraction/Fourier';
ResultPath = '/home/pliu/Documents/LayerPRF/Layer_Specific/08_LayerExtraction/Fourier/Difference';
...
D2D3Signal_young = load([Conditions{1} '_res_percent_signal_change_young']);
D2D3Signal_old = load([Conditions{1} '_res_percent_signal_change_old']);

D2Signal_young = load([Conditions{2} '_res_percent_signal_change_young']);
D2Signal_old = load([Conditions{2} '_res_percent_signal_change_old']);

D3Signal_young = load([Conditions{3} '_res_percent_signal_change_young']);
D3Signal_old = load([Conditions{3} '_res_percent_signal_change_old']);
...
for i_young=1:size(Young, 2)
        ...
        cd(ResultPath);
        Result = [CurrSubj '_res_percent_signal_change_difference'];
        ...
        cd(DataPath);
        GroupResult = 'res_all_percent_signal_change_difference_young';
...
for i_old=1:size(Old, 2)
        ...
        cd(DataPath);
        GroupResult = 'res_all_percent_signal_change_difference_old';
