...
percent_signal_change_young='D3_calibrated_res_percent_signal_change_young.mat';
load(percent_signal_change_young);
percent_signal_change_old='D3_calibrated_res_percent_signal_change_old.mat';
...
for ind = 1:n_young    
    figure(1)        
    plot(x_axis,res_percent_signal_change_young(:,ind),'o','MarkerSize',6,'MarkerEdgeColor',color_ind,'MarkerFaceColor',color_ind)
    hold on;
end
...
for ind = 1:n_old    
    figure(2)        
    plot(x_axis,res_percent_signal_change_old(:,ind),'o','MarkerSize',6,'MarkerEdgeColor',color_ind,'MarkerFaceColor',color_ind)
    hold on;
end
