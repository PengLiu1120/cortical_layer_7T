...
%% ........................................................................Set directory
Result_Dir = '/home/pliu/Documents/LayerPRF/Layer_Specific/08_LayerExtraction/Fourier';
...
for ind = 1:n_young    
    figure(1)        
    plot(x_axis,res_percent_signal_change_difference_young(:,ind),'o','MarkerSize',6,'MarkerEdgeColor',color_ind,'MarkerFaceColor',color_ind)
    hold on;
end
...
for ind = 1:n_old    
    figure(2)        
    plot(x_axis,res_percent_signal_change_difference_old(:,ind),'o','MarkerSize',6,'MarkerEdgeColor',color_ind,'MarkerFaceColor',color_ind)
    hold on;
end
