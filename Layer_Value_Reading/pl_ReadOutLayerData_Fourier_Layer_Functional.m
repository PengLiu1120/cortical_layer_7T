%% Read out layer-specific fourier data
% .........................................................................
% This script reads out fourier data at layer-specific for 19 layers.
% .........................................................................
% Written by P.Liu
% Optimized by P.Liu
...
% .........................................................................Results folder
ResultDir = '08_LayerExtraction/Fourier_Layer';
...
%% ........................................................................Extract values for each layer from Fourier mapping results
for i_cond = 1:size(Conditions, 2)
    ...
    for i_map = 1:size(Maps, 2)
        ...
        for i_sub=1:size(Subjects, 2)
            ...
            DataPath = fullfile(RootDir, DataDir, [CurrCond '_' CurrMap '_layer'], Currexp);
            cd(DataPath);
            ...
            layer_result = [CurrSubj '_' CurrCond '_' CurrMap];
            save(layer_result, 'tval_layers');
            
            All_Layers_Result = [CurrSubj '_' CurrCond '_' CurrMap '_all'];
