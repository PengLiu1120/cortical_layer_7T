function [vertex,face,scalar,header1,header2,header3] = read_vtk_deep(filename)
...
%%% read scalars %%%
[C,cnt] = fscanf(fid,'%f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f', 10*nvert);
if cnt~=10*nvert
    warning('Problem in reading scalars.');
end
C = reshape(C, 10, cnt/10);
scalar = C;
