function [vertex,face,scalar,header1,header2,header3] = read_vtk_all(filename)
...
%%% read scalars %%%
[C,cnt] = fscanf(fid,'%f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f', 21*nvert);
if cnt~=21*nvert
    warning('Problem in reading scalars.');
end
C = reshape(C, 21, cnt/21);
scalar = C;
