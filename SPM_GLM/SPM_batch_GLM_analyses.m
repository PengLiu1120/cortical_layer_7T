...
% August 2018: Restricted script only to perform statistics (Esther Kuehn,
...
% names of subjects (list all names of subject directories), here example:
% one subject, you can also add more subjects
name_subj = {'fip66_4571/blocked_design1'};

% definition of conditions: here as example: the five fingers D1 to D5
