...
dir_base        = '/Volumes/IKND/AG_Kuehn/Peng/LayerPRF/LayerPRF/Young'; % directory which contains all subject-specific directory
dir_analysis    = 'Results/Localiser';    % directory where SPM.mat, beta images, con images etc. are stored for each subject
dir_functional  = 'Functional/Localiser'; % directory of functional data (NIfTI files)
...
name_subj = {'ejk164' 'gxo876' 'kdy341' 'nhm378' 'unk742'};

% definition of conditions
cond_names   = {'motor','rest'};
