clear all;clc
names = {'jlf','kvv','mhc','mln','npx','nsu','oxi','pdo','pnj','sxp','uzf','wbs','wtl','yhx','zmk','zyr'}; % use if processing single subject

datadir = '/Users/anorthall/Documents/sensemap/Functional/data';
script_dir = '/Users/anorthall/Documents/sensemap/Functional/scripts';
addpath /Users/anorthall/Downloads/spm12;

% get list of subjects - if processing group
%d=dir(datadir);
%d=d([d(:).isdir]);
%d=d(~ismember({d(:).name},{'.','..'}));
%d=struct2cell(d);
...
n_scans         = 302;    % scans per session
TR              = 2.0;      % repetition time in s
num_slices      = 81;     % number of slices
ref_slice       = 40;     % reference slice for slice timing (e.g. first slice or middle slice)
...
dir_base        = '/Users/anorthall/Documents/sensemap/Functional/data'; % directory which contains all subject-specific directory
% dir_base        = '/home/tellezi/Documents/Functional_data'; % directory which contains all subject-specific directory
...
slice_ord       = [0 75 0 75 0 75 150 222.5 150 222.5 150 222.5 297.5 372.5 297.5 372.5 297.5 372.5 447.5 520 447.5 520 447.5 520 595 670 595 670 595 670 745 817.5 745 817.5 745 817.5 892.5 967.5 892.5 967.5 892.5 967.5 1042.5 1115 1042.5 1115 1042.5 1115 1190 1265 1190 1265 1190 1265 1340 1412.5 1340 1412.5 1340 1412.5 1487.5 1562.5 1487.5 1562.5 1487.5 1562.5 1637.5 1710 1637.5 1710 1637.5 1710 1785 1860 1785 1860 1785 1860 1932.5 1932.5 1932.5];	% Syntax: [first_slice:increment/decrement:last_slice]
							% Examples:
...
% name_subj = {'ep59', 'dqu023','pnj156','hdr235','gia487','unm323','wbs789', 'sc17' };
% name_subj = {'gia'};
% definition of conditions
cond_names   = {'timeHandLeft','timeHandRight','timeFootLeft','timeFootRight','timeTongue'};
...
c_name = {'HandLeft_vs_all' ; 'HandRight_vs_all' ; 'FootLeft_vs_all' ; 'FootRight_vs_all' ; 'Tongue_vs_all' };
...
% [-70 -108 15 ; 70 68 75]
	...
	SPM.xBF.dt         = TR/SPM.xBF.T;
        ...
        if rp
            ...
            for sess = 1:n_sess    
                movements=importdata('rp_adata.txt')
                r1=movements(:,1)
                r2=movements(:,2);
                r3=movements(:,3);
                r4=movements(:,4);
